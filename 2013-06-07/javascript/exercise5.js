...
var random_generator = function(x,y,m){
	n = 1
	/*for the settlements*/
	if((x<=6 && x>=2 && y<=6 && y>=2)||(x<=17 && x>=11 && y<=6 && y>=2)||(x<=21 && x>=13 && y<=21 && y>=13)
		||(x<=15 && x>=2 && y<=4.7 && y>=2.5)||(x<=15.2 && x>=12.5 && y<=15 && y>=2))
		n = 0
...
/**********************************************THE ROADS****************************************/
road1 = T([1])([4])(T([0])([2.3])(COLOR([1,1,1])(CUBOID([11,0.2,0.05]))))
road2 = T([0])([0.55])(COLOR([1,1,1])(CUBOID([0.2,3.5,0.05])))
road3 = T([1])([1.5])(COLOR([1,1,1])(CUBOID([3,0.2,0.05])))
road4 = T([0])([-0.3])(COLOR([1,1,1])(CUBOID([0.2,3.5,0.05])))
road5 = T([0])([1.6])(COLOR([1,1,1])(CUBOID([0.2,3.5,0.05])))
road6 = T([1])([3])(T([0])([12.7])(COLOR([1,1,1])(CUBOID([0.2,10.97,0.05]))))
road7 = T([1])([3])(T([0])([13.55])(COLOR([1,1,1])(CUBOID([0.2,10.97,0.05]))))
road8 = T([1])([14])(T([0])([12.6])(COLOR([1,1,1])(CUBOID([2.5,0.2,0.05]))))
road9 = T([1])([14])(T([0])([12.6])(COLOR([1,1,1])(CUBOID([0.2,1,0.05]))))
settlements = STRUCT([random_settlement_line(2),T([1])([2])(random_settlement_line(2)),
	T([1])([2])(T([0])([1])(random_settlement_line(2))),T([0])([1])(random_settlement_line(2)),road2,road3,road4,road5])
...
/*************************************************THE FINAL MODEL************************************************/
final_model = STRUCT([dtm_lake_forest,settlements_traslated,road1,road6,road7,road8,T([0])([0.6])(road9),T([0])([1.44])(road9),T([0])([2.5])(road9)])