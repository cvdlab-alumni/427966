...
def repeatTraslation(object,ax,t,n):
	stripes = object
	for i in range(n):
...
border3 = T([3])([0])(T([1])([1.2])(T([2])([-1.6])(R([1,3])(-PI/2)(CUBOID([8,0.2,0.2])))))
border4 = T([3])([0])(T([1])([7])(T([2])([-1.6])(R([1,3])(-PI/2)(CUBOID([8,0.2,0.2])))))
